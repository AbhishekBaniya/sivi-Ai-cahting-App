...
class AppTheme {
  ...
  static ThemeData get light => ThemeData.light(useMaterial3: true).copyWith(
    ...
    checkboxTheme: CheckboxThemeData(
      checkColor: WidgetStateProperty.all(ColorManager.darkPrimaryColor),
    ...
    switchTheme: SwitchThemeData(
      trackColor: WidgetStateProperty.resolveWith(
        (value) => ColorManager.darkPrimaryColor,
      ),
  ...
  static TextStyle get headlineSmall => TextStyle(
    color: ColorManager.textAndIconColor,
    fontSize: 20,
  ...
  // Default Theme
  static IconThemeData get defaultTheme =>
      IconThemeData(size: 24.0, color: ColorManager.accentColor, opacity: 1.0);
}
